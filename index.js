...
function handleText(message, replyToken, source) {
  ...
  switch (message.text) {
    ...
    default:
      console.log(`Echo message to ${replyToken}: ${message.text}`);var author;// = { type:'', id:'' ,username:'', status:'', avatarURL:'' };
      var author;
      client.getProfile(source.userId)
      .then((profile) => {
      console.log('[Profile]');
      console.log(profile);
      let pauthor = { type:'', id:'' ,username:'', status:'', avatarURL:'' };
      pauthor.id = profile.userId;
      pauthor.username = profile.displayName;
      pauthor.avatarURL = profile.pictureUrl;
      pauthor.status = profile.statusMessage;
      pauthor.type = source.type;
      author = pauthor;
      });
